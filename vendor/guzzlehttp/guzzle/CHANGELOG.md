...
Please refer to [UPGRADING](Desktop/newproject/vendor/guzzlehttp/guzzle/UPGRADING.md) guide for upgrading to a major version.
...
Please see [the upgrade document](Desktop/newproject/vendor/guzzlehttp/guzzle/UPGRADING.md) that describes all BC breaking changes.
