...
`Header::normalize()` is deprecated in favor of [`Header::splitList()`](Desktop/newproject/vendor/guzzlehttp/psr7/README.md#guzzlehttppsr7headersplitlist)
...
Guzzle is made available under the MIT License (MIT). Please see [License File](Desktop/newproject/vendor/guzzlehttp/psr7/LICENSE) for more information.
