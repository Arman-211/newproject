...
final readonly class Application
{
    ...
    {
        print Application . phpVersion::getVersionString() . PHP_EOL;
    ...
    {
        $printer->print(Application . phpVersion::getVersionString() . PHP_EOL);
    ...
    {
        print Application . phpVersion::getVersionString() . PHP_EOL . $message . PHP_EOL;
